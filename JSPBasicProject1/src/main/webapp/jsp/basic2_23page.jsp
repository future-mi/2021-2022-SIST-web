...
<%--
	...
	→ MVC(Controller), 보안요구, Spring파일은 서블릿으로 제공 
	
	33page
	→ 설치(JDK,Tomcat,이클립스) → 일반자바 87page~117page
	...
	- 자바 코딩하는 영역
	  <%
	  	메소드 안에 코딩 → _jspService() → 선언되는 모든 변수는 지역변수
	  %>
	  <%!
	  	클래스영역에서 설정 → 메소드 선언 → (X)
	  %>
