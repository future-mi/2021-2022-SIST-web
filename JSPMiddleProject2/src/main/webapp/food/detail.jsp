...
<%
    ...
    String temp=addr.substring(addr.indexOf(" "));
...
<body>
  <div class="container">
    ...
    <div class="col-sm-7">
      <table class="table">
        <tr>
          <td colspan="2"><h2><%=vo.getName() %>&nbsp;<span style="color:orange"><%=vo.getScore() %></h2></span></td>
        </tr>
        <tr>
           ...
           %>
                <table class="table">
                  <tr>
                    ...
                    %>
                        <a href="#" class="btn btn-ss btn-success">수정</a>
                        <a href="#" class="btn btn-ss btn-info">삭제</a>
                    <%
                      }
                    %>
                    </td>
    ...
    <div id="map" style="width:100%;height:350px;"></div>
        ...
        <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2318499d399b5762e6130fcae4a61028&libraries=services"></script>
        <script>
