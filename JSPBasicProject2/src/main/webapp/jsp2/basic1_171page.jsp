...
<%--
	...
	- request : 사용자정보(브라우저정보) → 접속자의 IP, 서버주소
				사용자의 요청 정보를 가지고 있다
				사용자가 데이터를 전송 → request를 이용해서 데이터를 받는다
				추가해서 재전송이 가능
				
	- response : 응답정보(HTML, Cookie)
   ...
   <table class="table">
    ...
    <tr>
     ...
     <td>
       ...
       <ul>
        <li>서버정보(URL,URI,ContextPath)</li>
    ...
    <tr>
     <th class="text-center success">주요메소드</th>
     <td>
      <ul>
       ...
       <li>setCharterEncoding() : 한글변환 / 전송 1byte → 받을경우 2byte</li>
      </ul>
      <b>http://localhost/JSPBasicProject2/jsp2/basic1_171page.jsp</b><br>
      localhost → 서버정보 <br>
      JSPBasicProject2/jsp2/basic1_171page.jsp → 사용자가 요청한 부분(URI) → ContextPath<br>
     </td>
    </tr>
   </table>
  </div>
