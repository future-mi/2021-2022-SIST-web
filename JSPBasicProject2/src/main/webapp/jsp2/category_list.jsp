...
<%
	// 1. 이전 JSP에서 보내준 데이터를 받는다
	String cno=request.getParameter("cno");
	// 2. cno에 해당되는 데이터 벵스 값을 가지고 온다
...
<body>
 <div class="container">
  <div class="jumbostron">
   ...
   <h4 class="text-center" style="color:blue"><%=vo.getSubject() %></h4>
  </div>
  <div class="row">
  <table class="table">
   <tr>
   ...
   %>
   	 <table class="table">
   	  <tr>
   	    ...
   	    <td width="70%"><h1><a href="food_detail.jsp?no=<%=fvo.getNo()%>"><%=fvo.getName() %></a>&nbsp;<span style="color:orange"></span></h1></td>
   	  </tr>
   	  <tr>
