...
<%
	// 1. 사용자가 보내준 데이터를 받는다(맛집번호)
	String no=request.getParameter("no");
	// 2. 맛집 번호를 오라클로 보내고 오라클에 저장된 데이터 받기
	FoodService dao=new FoodService();
	FoodVO vo=dao.foodDetailData(Integer.parseInt(no));
	// → 자바에서 데이터 읽기 : 오라클, 웹크롤링, 파일
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    ...
    <
    <div class="col-sm-8">
      <h3><%=vo.getName() %>&nbsp;<span style="color:orange"><%=vo.getScore() %></h3>
      <table class="tabel">
        <tr>
        ...
        <tr>
          <td colspan="2" class="text-right">
            ...
            <a href="javascript:history.back()" class="btn btn-sm btn-success"></a>
          </td>
        </tr>        
      </table>
    </div>
